...
const ENV = (process.env.VERCEL || IS_SERVERLESS) ? join(DATA_DIR, 'settings.env') : join(ROOT, '.env');
...
export const FIELDS = {
  ...
  FIREBASE_PROJECT_ID: { label: 'Firebase Project ID', unlocks: 'Identifies your Firebase project for Google Sign-In and team accounts.', how: 'Firebase Console → Project Settings → Project ID', optional: true },
  FIREBASE_API_KEY: { label: 'Firebase Web API key', unlocks: 'Powers Firebase client authentication.', how: 'Firebase Console → Project Settings → General → Your apps → apiKey', optional: true, secret: true },
  FIREBASE_AUTH_DOMAIN: { label: 'Firebase Auth Domain', unlocks: 'OAuth redirect domain (defaults to <project-id>.firebaseapp.com).', how: 'Firebase Console → Project Settings → authDomain', optional: true },
  FIREBASE_APP_ID: { label: 'Firebase App ID', unlocks: 'Identifies your Firebase web app.', how: 'Firebase Console → Project Settings → appId', optional: true },
  FIREBASE_STORAGE_BUCKET: { label: 'Firebase Storage Bucket', unlocks: 'Cloud storage bucket for Firebase assets.', how: 'Firebase Console → Project Settings → General', optional: true },
  FIREBASE_MESSAGING_SENDER_ID: { label: 'Firebase Messaging Sender ID', unlocks: 'Cloud messaging sender ID.', how: 'Firebase Console → Project Settings → Cloud Messaging', optional: true },
  FIREBASE_MEASUREMENT_ID: { label: 'Firebase Measurement ID', unlocks: 'Google Analytics measurement ID for Firebase web app.', how: 'Firebase Console → Project Settings → General', optional: true },
};
...
async function persist(updates) {
  ...
  try {
    ...
    // In serverless, settings remain active in-memory in process.env
  }
}
